...
import com.idxk.mobileoa.config.enums.MessageType;
    ...
    public int getItemViewType(int position) {
        try {
            ...
            if (obj instanceof Integer) {
                ...
                Logger.e("infoinfo.getFromId()==="+info.getFromId()+info.getUserId()+info.getTo_user_id());
...
//                    ((MessageEntity) o).setId(success ? messageEntity.getId() : 0);
    ...
    private View imageMsgRender(final int position, View convertView, final ViewGroup parent, final boolean isMine) {
        ...
        Logger.e("sdddddddddddddddddddddddd"+imageMessage.toString());
