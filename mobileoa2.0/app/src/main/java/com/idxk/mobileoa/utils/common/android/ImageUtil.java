...
public class ImageUtil {
    ...
    public static Bitmap zoomBitmap(Bitmap bitmap, int w, int h) {
        ...
        Logger.e("-------bitmap 是空的----" + w);

        int width = bitmap.getWidth();
        Logger.e("-------bitmap 是空的-width---" + width);
        if (w == 0) {
            w = 520;
        }
        ...
        float scale = bitmap.getWidth() / bitmap.getHeight();
    ...
    public static Bitmap getRoundedCornerBitmap(Bitmap bitmap, float raduis) {
...
//		canvas.drawRoundRect(rectF, roundPx, roundPx, paint);
        paint.setShadowLayer(5, 3, 3, 0x464f5a);
        canvas.drawRoundRect(rectF, raduis, raduis, paint);
//        canvas.drawCircle(bitmap.getWidth()/2,bitmap.getWidth()/2,raduis*3,paint);
