...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        Log.d(TAG + "test", responseString);
//        ToastTool.show(responseString);
        ...
        PreferceManager.getInsance().saveValueBYkey("baiDuPushUserId", userId, context);
        PreferceManager.getInsance().saveValueBYkey("baiDuPushChannelId", channelId, context);
        HashMap<String, Object> hashMap = new HashMap<String, Object>();
        hashMap.put("user_id", userId);
        hashMap.put("channel_id", channelId);
        hashMap.put("type", IConstant.PUSHTYPE);
        BaiDuPushController.getInstance().bindBaiDuPush(new ViewNetCallBack() {
            @Override
    ...
    public void onMessage(Context context, String message,
        ...
        Log.e(TAG + "onMessage", messageString);
        ToastTool.show(messageString);
...
//        context.getApplicationContext().startActivity(intent);
    ...
    public void onSetTags(Context context, int errorCode,
        ...
        String responseString = "onSetTags errorCode=" + errorCode
                ...
                + " requestId=" + requestId;
        ToastTool.showDev(responseString);
...
//            HashMap<String, Object> hashMap = new HashMap<String, Object>();
//
//            hashMap.put("user_id", PreferceManager.getInsance().getValueBYkey(context, "baiDuPushUserId"));
//            hashMap.put("channel_id", PreferceManager.getInsance().getValueBYkey(context, "baiDuPushChannelId"));
