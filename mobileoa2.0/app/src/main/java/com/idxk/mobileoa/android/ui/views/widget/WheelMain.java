...
public class WheelMain {
    ...
    public String getTime() {
        ...
        String monthstr = String.valueOf(month).length() == 2 ? String.valueOf(month) : "0" + month;
        int day = wv_day.getCurrentItem() + 1;
        String daystr = String.valueOf(day).length() == 2 ? String.valueOf(day) : "0" + day;
        int hours = wv_hours.getCurrentItem();
        String hourstr = String.valueOf(hours).length() == 2 ? String.valueOf(hours) : "0" + hours;
        int minutes = wv_mins.getCurrentItem();
        String minustr = String.valueOf(minutes).length() == 2 ? String.valueOf(minutes) : "0" + minutes;
        if (iTime == 1) {
